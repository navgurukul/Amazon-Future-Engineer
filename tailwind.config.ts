...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        "amazon-ember": ["Amazon Ember", "Amazon Ember Display",],
        ...
        // use these fonts
        "heading1-bold": ["Amazon Ember Display", ],
        "heading2-bold": ["Amazon Ember Display", ],
        "heading3-bold": ["Amazon Ember Display", ],
        "heading4-bold": ["Amazon Ember Display", ],
        "heading5-bold": ["Amazon Ember Display", ],
        "heading6-bold": ["Amazon Ember Display", ],
        "subTitle1-bold": ["Amazon Ember", ],
        "subTitle2-bold": ["Amazon Ember", ],
        "body1-regular": ["Amazon Ember", ],
        "body2-regular": ["Amazon Ember", ],
        "button1-bold": ["Amazon Ember", ],
        "button2-bold": ["Amazon Ember", ],
      },
      screens: {
        xs: "320px",
        sm: "375px",
