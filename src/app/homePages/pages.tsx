...
//   return (
//     <div className="w-full relative bg-white h-[5194px] overflow-hidden text-left text-2xl text-[#3a3a3a] font-['Amazon Ember Display']">
//       <section className="absolute top-[1538px] left-[calc(50%-217px)] leading-[150%] font-extrabold text-center hidden">
//         Frequently Asked Questions
//       </section>

//       <section className="absolute top-[1615px] left-[320px] w-[800px] hidden flex flex-col items-start justify-start gap-[32px] text-[18px] font-['Amazon Ember']">
//         <h2 className="relative text-[24px] leading-[150%] font-extrabold font-['Amazon Ember Display']">
//           Fellowships
//         </h2>
...
//   </div>
// </section> */}
//       <section className="relative w-[1728px] h-[1117px] text-center text-[56px] text-gray-200 font-['Amazon Ember']">
//         <video
...
//         <header className="absolute top-[200px] left-12 w-[1215px] flex flex-col gap-12 items-start text-left font-['Amazon Ember Display']">
//           <div className="w-full flex flex-col gap-4 items-start">
//             <h1 className="w-full relative font-extrabold leading-[150%]">
//               WELCOME TO AMAZON FUTURE ENGINEERS INNOVATION HUB
//             </h1>
...
//           <div className="flex flex-row gap-8 items-start text-[18px] text-white font-['Amazon Ember']">
//             <button
...
//         <nav className="absolute top-12 left-[1569px] flex items-center justify-center px-8 py-2 bg-gray-200 text-[#f55c38] rounded-full h-14 text-[18px] cursor-pointer" onClick={handleBookSessionClick}>
//           <span className="relative font-medium leading-[170%]">Login</span>
//         </nav>
...
//       <section className="absolute top-[3420px] left-8 w-[1664px] hidden flex-row items-center justify-start gap-8 text-[18px] font-['Amazon Ember']">
//         <article className="flex-shrink-0 w-[815px] rounded-[16px] bg-[#d4dae8] flex flex-col items-start justify-between p-8 text-[24px] font-['Amazon Ember Display']">
...
//           Have Any Questions?
//         </h2>
//         <p className="w-full relative text-[18px] leading-[170%] font-['Amazon Ember'] text-[#3a3a3a]">
//           <strong>
...
//           </h2>
//           <p className="w-full relative text-[18px] leading-[170%] font-medium text-[#3a3a3a] font-['Amazon Ember']">
...
//         <b className="absolute top-[35.5px] left-[calc(50%-59px)] text-[18px] leading-[170%] font-[Amazon Ember]">
//           Privacy Policy
//         </b>
