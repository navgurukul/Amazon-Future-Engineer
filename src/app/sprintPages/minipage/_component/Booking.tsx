...
const Booking = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="leading-[170%] font-medium">2 Days (3 hours per day)</div>
      </div>
    </div>
    <div className="flex flex-row items-center gap-4 text-darkslategray">
      <img
        ...
        <p className="w-full relative text-[14px] md:text-[20px] leading-[170%] font-medium text-[#3a3a3a] font-['Amazon Ember'] mt-4">
          ...
          <div className="hidden lg:block lg:w-1/3 w-full sticky top-32 h-full">
            <div className="w-full relative rounded-lg bg-incandescent-light border-[2px] border-incandescent-main p-8 gap-8">
              <h1 className="text-darkslategray leading-[150%] lg:text-[20px] md:text-[16px] text-[12px] font-bold font-extrabold font-[Amazon Ember]">Coming Soon!</h1>
    <p className="text-darkslategray leading-[150%] font-extrabold font-[Amazon Ember] lg:text-[17px] md:text-[12px] text-[10px] font-medium mt-4 mb-8">Be the first to know when Mini Sprints launch. Leave your details to receive updates</p>
  ...
  <div className="flex flex-col gap-4 text-center" onClick={handleRoute}>
