...
// const MainContent = () => {
//   return (
//     <div className="px-4 py-16 sm:px-8 md:px-12 max-w-[70%] mx-auto flex flex-col gap-8">
...
//       <div className="w-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 text-left text-lg md:text-4xl text-text-primary font-webtypestyles-h6">
...
//       <div className="max-w-full text-2xl md:text-4xl lg:text-5xl leading-[150%] font-extrabold font-webtypestyles-h5 text-[#29458c] text-left mt-10">
...
const MainContent = () => {
  return (
    ...
    <div className="py-16 max-w-[70%] mx-auto flex flex-col gap-8">
      ...
      {/* Increased heading size */}
      <div className="max-w-[70%] text-2xl md:text-13xl lg:text-4xl leading-[150%] font-extrabold font-webtypestyles-h5 text-[#29458c] text-left mt-6 md:mt-10">
        Nano Sprints: One-Day Introductory Sessions to Spark Interest and Build Aspiration
      </div>
