...
const SecondPopup: NextPage = () => {
  return (
    <>
      ...
      {/* Popup Container */}
      <div
        className="fixed w-full sm:w-2/3 md:w-1/2 lg:w-1/3 max-w-lg bg-white z-50 p-6 md:p-8 gap-4 shadow-lg rounded-lg text-left text-gray-500 font-nunito-sans
        flex flex-col items-center justify-center
