...
const Header: React.FC = () => {
  ...
  return (
    <div className=" flex justify-between items-center px-12 py-8 w-full shadow-md bg-bg-surface-default text-center text-sm font-webtypestyles-buttonlarge fixed top-0 z-50 left-0">
      {/* Logo */}
