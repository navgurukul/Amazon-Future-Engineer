...
export default function BookingDetailsPage({ onStartSprint }) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-8 space-y-16">
      <div className="space-y-8">
        <h1 className="text-4xl font-extrabold text-midnight-blue-main">
          Booking Details
        </h1>
        <Card>
          <CardContent className="pt-6 space-y-6">
      ...
      <div className="space-y-4">
        <h2 className="text-4xl font-extrabold text-midnight-blue-main">
          Sprint Feedback
        </h2>
        <p className="text-lg font-medium text-text-primary">
          Feedback from teachers and students can be gathered after the sprint
          has completed and added here once the sprint is marked as completed.
        </p>
      </div>
    </div>
  );
