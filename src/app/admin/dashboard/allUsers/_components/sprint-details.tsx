...
export const SprintDetailsComponent: React.FC<{ booking: Booking }> = ({
  ...
  const [bookingDetails, setBookingDetails] = useState<BookingDetails | any>(null);
  ...
  return (
    <>
    {isCalendar ? (
      <Booking handleCalendar={closeCalendar} bookingDetails={bookingDetails} calendarData={calendarData} />
    ) : (
      <div>
                      ...
                      return (
                        ...
                        >
                          ...
                          {key === "programName" || key === "grade" ? (
                            ...
                            readOnly={key === "phoneNumber" || key === "dateofRequest" || key === "city"
                              }
