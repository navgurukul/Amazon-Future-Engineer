    ...
    const fetchData = async () => {
      try {
        ...
        setUserData((prevData) => {
          console.log("Previous userData:", prevData);
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-50 bg-white shadow-md">
        <Header
          isLoggedIn={true}
          handleOfflineBooking={function (): void {
      ...
      <div className="w-full max-w-[90%] sm:max-w-[1216px] h-auto mx-auto relative flex flex-col items-center gap-8 ">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-[33px] w-full">
          ...
          <div className="w-full sm:w-[487px] flex flex-col gap-4">
            ...
            <div>
              <span>For queries, please call or Whatsapp us on </span>
              <span className="text-[#f55c38] font-extrabold">
                +918764674356
              </span>
            </div>
          </div>
      ...
      {/* <div className=" max-w-[90%] sm:w-[1216px] h-auto flex flex-col justify-center items-start gap-8 mx-auto relative mt-8">
                ...
                <div className=" sm:w-auto h-12 px-8 py-2 bg-[#f55c38] rounded-[100px] justify-center items-center mb-4 gap-2 flex cursor-pointer"
      ...
      <div className="max-w-[90%] sm:w-[1216px] h-auto flex flex-col sm:flex-row justify-between items-start gap-8 mx-auto relative mt-8">
        ...
        <div className="flex flex-col justify-start items-start gap-4">
          ...
          {/* Button */}
          <div
            className="sm:w-auto h-12 px-8 py-2 bg-[#f55c38] rounded-[100px] justify-center items-center mb-4 gap-2 flex cursor-pointer"
            onClick={handleViewSprintDetails}
          >
            <div className="text-center text-white text-base font-medium font-['Amazon Ember'] leading-7">
              View Sprint Details
