    ...
    <>
              ...
              <div className="flex flex-col sm:flex-row space-x-0 sm:space-x-4 space-y-2 sm:space-y-0">
                <div className="flex items-center space-x-2">
                  <Image
                    ...
                    height={20}
                  />
                  <div className="text-[#3a3a3a] flex items-center text-lg font-medium font-['Amazon Ember'] leading-[30.60px]">
                    24 Sept 2024
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                ...
                >
                  <DialogContent className="bg-white w-full sm:fixed top-[75%] md:top-[50%]  max-w-[592px] sm:w-[592px] h-auto sm:h-[377px] p-6 ">
                    <DialogHeader>
                      <DialogTitle>
                        <div
                          style={{ fontSize: "24px", fontWeight: "800px" }}
                          className="text-[#3a3a3a] text-left text-xl sm:text-2xl font-extrabold font-['Amazon Ember Display'] leading-7 sm:leading-9"
                        >
                    ...
                    <DialogDescription className="mt-2 text-gray-600">
                      ...
                      <div className="whitespace-normal text-black text-lg font-medium font-['Amazon Ember'] leading-6 sm:leading-[30.60px] mt-4">
                        <span className="block sm:inline">
                          We recommend to reschedule only in cases
                        </span>
                        <span className="block sm:inline  mr-1">
                          of emergencies. Please confirm if you would
                        </span>
                    ...
                    {openAnotherDialog && (
                      <Dialog
                        ...
                        onOpenChange={setOpenAnotherDialog}
                      >
                          ...
                          <DialogHeader>
                            <DialogTitle className="flex justify-between items-center">
                              <div
                                ...
                                className="text-[#3a3a3a] text-xl sm:text-2xl font-extrabold font-['Amazon Ember Display'] leading-7 sm:leading-9"
                              >
                                Reschedule Nano Sprint
                              </div>
                              <button
                                onClick={handleCloseAnother}
                                className="w-6 h-6"
                              />
                            </DialogTitle>
                          </DialogHeader>
                          <DialogDescription>
                            ...
                            <div className="whitespace-normal text-[#3a3a3a] text-lg font-medium font-['Amazon Ember'] leading-6 sm:leading-[30.60px] mt-4">
                              <span className="block sm:hidden">
                                Please contact us at the phone number
                              </span>
                              <span className="block sm:hidden">
                                below to confirm your sprint rescheduling
                              </span>
                              <span className="hidden sm:inline">
                                Please contact us at the phone number below to
                                confirm your
      ...
      <div className="w-full max-w-[90%] sm:max-w-[1216px] h-auto mx-auto relative flex flex-col items-center gap-8 p-4">
        <div className="text-[#29458c] text-[24px] font-extrabold leading-[36px] text-left sm:text-[32px] sm:leading-[48px] self-start">
          How to Reach AFE Makerspace Lab
        </div>
        <div className="flex flex-col sm:flex-row items-start gap-4 w-full">
          ...
          <div className="w-full sm:w-[487px] flex flex-col gap-4">
            <div className="text-[#3a3a3a] text-2xl font-extrabold leading-9">
              AFE Makerspace Lab
            </div>
            ...
            <div>
              ...
              <a
                href="mailto:afeinnovation@ihub.com"
                className="text-[#f55c38] font-semibold underline"
              >
