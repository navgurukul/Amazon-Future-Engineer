...
// //                             <div className="text-lg text-left font-extrabold">Nano Sprint</div>
...
// //                                 <div onClick={handleOpenReschedule} className="text-center text-[#f55c38] text-lg font-medium font-['Amazon Ember'] leading-[30.60px] sm:text-base sm:leading-7 cursor-pointer">
// //                                     Reschedule
// //                                 </div>
// //                             </div>
              ...
              <div className="h-14 px-8 py-2 rounded-[100px] border border-[#f55c38] justify-center items-center gap-2 inline-flex hover:bg-transparent w-full sm:w-48 sm:px-6 sm:py-2 mt-4">
                ...
                {[...Array(3)].map((_, index) => (
                    ...
                    >
                        ...
                        <div>
                            <div className="h-14 px-8 py-2 rounded-[100px] border border-[#f55c38] justify-center items-center gap-2 inline-flex hover:bg-transparent w-full sm:w-48 sm:px-6 sm:py-2 mt-4">
                                <div className="text-center text-[#f55c38] text-lg font-medium font-['Amazon Ember'] leading-[30.60px] sm:text-base sm:leading-7 cursor-pointer" onClick={handleOpenFirstPopup} >
                                    Reschedule
                                </div>
                            </div>
                        </div>
